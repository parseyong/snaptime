...
public class ReplyServiceImpl implements ReplyService {
    ...
    public void addParentReply(String reqLoginId, ParentReplyAddReqDto parentReplyAddReqDto){
        ...
        alarmAddService.addReplyAlarm(reqUser, snap.getUser(), snap, parentReplyAddReqDto.replyMessage());
    }
    ...
    public ChildReplyPagingResDto findChildReplyPage(Long parentReplyId, Long pageNum){
        ...
        {
            String profilePhotoURL = urlComponent.makePhotoURL( tuple.get(writerUser.profilePhotoName),false);
